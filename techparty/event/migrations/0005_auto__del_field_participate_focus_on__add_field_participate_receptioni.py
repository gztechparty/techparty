...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Participate.focus_on'
        db.delete_column(u'event_participate', 'focus_on')

        # Adding field 'Participate.receptionist'
        db.add_column(u'event_participate', 'receptionist',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Participate.focus_on'
        db.add_column(u'event_participate', 'focus_on',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Participate.receptionist'
        db.delete_column(u'event_participate', 'receptionist')
    ...
    models = {
        ...
        u'event.participate': {
            ...
            'receptionist': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
