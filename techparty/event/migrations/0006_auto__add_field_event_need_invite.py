...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.need_invite'
        db.add_column(u'event_event', 'need_invite',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.need_invite'
        db.delete_column(u'event_event', 'need_invite')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'need_invite': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'member.user': {
            ...
            'gendar': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
